...
export function Input({ className, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      className={cn(
        "h-11 w-full rounded-[--radius-inner] border border-line bg-surface-2 px-4 text-[15px]",
  ...
  return (
    <textarea
      className={cn(
        ...
        "text-[15px] text-fg placeholder:text-faint transition-colors duration-200 resize-y",
